# Script to download seismic data from a specified time window
...
)  # Start and end times, "%3A" is url encoding for ":"
# Download specifications
network, station, loc, channel, fmt = (
    "Y2",
    "71%2A",  # "%2A" is url encoding for "*" and represents all stations starting with "71"
    "--",
