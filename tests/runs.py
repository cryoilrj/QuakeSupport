...
run_script = Path("./run.py")  # Run
reset_script = Path("./reset.py")  # Reset

# QuakeMigrate run name
qm_run_name = "rutfordIL_test_run"
...
selected_starttime = UTCDateTime("2018-12-25T00:27:00.000000Z")
